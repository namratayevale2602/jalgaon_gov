...
import { FaFileAlt, FaFilePdf, FaExternalLinkAlt } from "react-icons/fa";
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <a
                        ...
                        className="mt-3 inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 no-underline cursor-pointer"
                      >
                        {loadingPdf === doc.id ? (
                          <>
                            <svg
