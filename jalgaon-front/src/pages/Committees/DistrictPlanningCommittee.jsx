...
const committeeData = {
      ...
      provisions: [
        {
          ...
          womenPercentage: 5,
          description: {
            en: "Proportionate to district population with 1/3 reserved for women",
            mr: "जिल्ह्यातील लोकसंख्येच्या प्रमाणात, त्यापैकी 1/3 महिलांसाठी राखीव",
          },
        },
        {
          category: {
        ...
        },
        {
          ...
          womenPercentage: 9,
          description: {
            en: "As per state government norms with 1/3 reserved for women",
            mr: "राज्य शासनाच्या निकषांनुसार, त्यापैकी 1/3 महिलांसाठी राखीव",
          },
        },
        {
          category: {
          ...
          percentage: 33,
          description: {
            en: "Across all categories including reserved categories",
            mr: "सर्व श्रेणींमध्ये (आरक्षित श्रेणींसह) एकूण 33%",
          },
        },
      ],
      electionRules: {
        en: [
          "Electoral constituencies: Rural, Transitional, Small Urban, Large Urban",
          "Reservation based on population proportion in each constituency",
          "District Collector supervises election process",
          "Electoral rolls prepared from local body members",
        ],
        mr: [
          "मतदार संघ: ग्रामीण, संक्रमणकालीन, लहान शहरी, मोठे शहरी",
          "प्रत्येक मतदार संघातील लोकसंख्येच्या प्रमाणात आरक्षण",
          "जिल्हाधिकारी निवडणूक प्रक्रियेचे निरीक्षण करतात",
          "स्थानिक संस्थेच्या सदस्यांपासून मतदार याद्या तयार केल्या जातात",
        ],
      },
    },
  },
  ...
  meetings: {
    upcoming: {
      ...
      agenda: {
        en: "Approval of Annual Development Plan 2024-25",
        mr: "2024-25 च्या वार्षिक विकास योजनेचे मंजुरी",
      },
    },
    previous: [
      {
        date: "2023-08-20",
        minutes: "/meetings/minutes_20230820.pdf",
        decisions: {
          en: [
            "Approved revised district development plan",
            "Allocated funds for rural infrastructure projects",
          ],
          mr: [
            "दुरुस्ती केलेली जिल्हा विकास योजना मंजूर",
            "ग्रामीण पायाभूत योजनांसाठी निधी वाटप",
          ],
        },
      },
    ],
    ...
    <div className="bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 bg-white p-4 rounded-lg shadow-md">
          <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden bg-blue-100 flex items-center justify-center h-64">
            <span className="text-xl text-blue-800">
              {language === "en"
                ? "Jalgaon District Planning Committee Photo"
                : "जळगाव जिल्हा नियोजन समितीचे फोटो"}
            </span>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="mt-8">
            <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
              ...
              {getText(committeeData.composition.reservationPolicy.title)}
            </h3>
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {committeeData.composition.reservationPolicy.provisions.map(
                    (item, idx) => (
                      <tr key={idx}>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">
              {getText(committeeData.functions.planning.title)}
            </h3>
            <div className="grid sm:grid-cols-2 gap-4">
              {committeeData.functions.planning.items.map(renderFunctionCard)}
            </div>
          </div>
          ...
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">
              {getText(committeeData.functions.coordination.title)}
            </h3>
            <div className="grid sm:grid-cols-2 gap-4">
              {committeeData.functions.coordination.items.map(
                renderFunctionCard
              )}
            </div>
          </div>
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-800 mb-4">
              {getText(committeeData.functions.monitoring.title)}
            </h3>
            <div className="grid sm:grid-cols-2 gap-4">
              {committeeData.functions.monitoring.items.map(renderFunctionCard)}
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="mb-4 text-sm text-gray-500">
            {language === "en"
              ? `Last updated: ${committeeData.currentMembers.lastUpdated}`
              : `अंतिम अद्यतन: ${committeeData.currentMembers.lastUpdated}`}
          </div>

          {/* Chairperson */}
          <div className="mb-6 bg-blue-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">
              {getText(committeeData.currentMembers.chairperson.position)}
            </h3>
            <div className="flex items-start">
              <FaUserTie className="text-blue-600 mr-3 mt-1 flex-shrink-0" />
              <div>
                <p className="font-medium text-gray-800">
                  {getText(committeeData.currentMembers.chairperson.name)}
                </p>
                <div className="mt-2 text-sm text-gray-600">
                  <p>
                    ...
                    {committeeData.currentMembers.chairperson.contact.office}
                  </p>
                  <p>
                    <span className="font-medium">
                      {language === "en" ? "Email:" : "ईमेल:"}
                    </span>{" "}
                    {committeeData.currentMembers.chairperson.contact.email}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-6 bg-blue-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">
              {getText(committeeData.currentMembers.memberSecretary.position)}
            </h3>
            <div className="flex items-start">
              <FaUserShield className="text-blue-600 mr-3 mt-1 flex-shrink-0" />
              <div>
                <p className="font-medium text-gray-800">
                  {getText(committeeData.currentMembers.memberSecretary.name)}
                </p>
                <div className="mt-2 text-sm text-gray-600">
                  <p>
                    <span className="font-medium">
                    ...
                    {
                      committeeData.currentMembers.memberSecretary.contact
                        .office
                    }
                  </p>
                  <p>
                    ...
                    {committeeData.currentMembers.memberSecretary.contact.email}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-3">
              {language === "en" ? "Other Members" : "इतर सदस्य"}
            </h3>
            <div className="grid sm:grid-cols-2 gap-4">
              {committeeData.currentMembers.otherMembers.map((member, idx) => (
                <div key={idx} className="border rounded-lg p-4">
                  <p className="font-medium text-gray-800">
                    {getText(member.name)}
                  </p>
                  <p className="text-sm text-gray-600 mt-1">
                    {getText(member.category)}
                  </p>
                </div>
              ))}
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
            <MdMeetingRoom className="mr-2 text-blue-600" />
            {language === "en" ? "Meetings" : "बैठका"}
          </h2>

          {/* Upcoming Meeting */}
          <div className="mb-6 bg-green-50 p-4 rounded-lg border border-green-200">
            <h3 className="text-lg font-semibold text-gray-800 mb-3 flex items-center">
              <HiCalendar className="mr-2 text-green-600" />
              {language === "en" ? "Upcoming Meeting" : "आगामी बैठक"}
            </h3>
            <div className="grid md:grid-cols-3 gap-4">
              <div>
                ...
                <p className="text-gray-800">
                  {committeeData.meetings.upcoming.date}
                </p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">
                  {language === "en" ? "Time" : "वेळ"}
                </p>
                <p className="text-gray-800">
                  {committeeData.meetings.upcoming.time}
                </p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">
                ...
                <p className="text-gray-800">
                  {getText(committeeData.meetings.upcoming.venue)}
                </p>
              </div>
            </div>
            <div className="mt-4">
              ...
              <p className="text-gray-800">
                {getText(committeeData.meetings.upcoming.agenda)}
              </p>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-3 flex items-center">
              ...
              {language === "en" ? "Previous Meetings" : "मागील बैठका"}
            </h3>
            <div className="space-y-4">
              {committeeData.meetings.previous.map((meeting, idx) => (
                <div
                  key={idx}
                ...
                >
                  <div className="grid md:grid-cols-3 gap-4 mb-3">
                    <div>
                      ...
                      <p className="text-gray-800">{meeting.date}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-500">
                        {language === "en" ? "Minutes" : "सारांश"}
                      </p>
                      <a
                      ...
                      >
                        ...
                        {language === "en" ? "View Minutes" : "सारांश पहा"}
                      </a>
                    </div>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500 mb-1">
                      {language === "en" ? "Key Decisions" : "मुख्य निर्णय"}
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
                      {meeting.decisions[language].map((decision, idx) => (
