...
const committeeData = {
  ...
  documents: [
    ...
    },
    {
      ...
      type: "structure",
      link: "jalgaon_dpc_structure.pdf",
      updated: "2023-01-15",
      description: {
    ...
    },
    {
      ...
      type: "rules",
      link: "dpc_election_rules_1999.pdf",
      updated: "1999-07-22",
      description: {
...
const DistrictPlanningCommittee = () => {
  ...
  const generatePdfContent = (docId) => {
    const doc = committeeData.documents.find((d) => d.id === docId);
    if (!doc) return null;

    // This would be the actual content of your PDF
    // For demonstration, we'll return a simple text representation
    return `
      ${getText(doc.title)}
      ...
      This is a sample PDF content for ${getText(doc.title)}.
      In a real application, this would be replaced with the actual document content.
      
      Jalgaon District Planning Committee
      Maharashtra, India
    `;
  };
  ...
  const handleDownload = (doc) => {
    ...
    // For this example, we'll create a blob with sample content
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="inline-flex items-center text-blue-600 text-sm mt-2 hover:underline disabled:opacity-50"
                    >
                      {downloading === doc.id
                        ? language === "en"
                          ? "Downloading..."
