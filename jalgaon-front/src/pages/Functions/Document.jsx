              ...
              {committeeData.documents.map((doc) => (
                ...
                >
                  <div className="flex items-start mb-4">
                    <div className="flex-shrink-0 h-12 w-12 rounded-lg bg-blue-50 flex items-center justify-center mr-4 group-hover:bg-blue-100 transition-colors">
                  ...
                  <div className="flex space-x-2 mt-4">
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center px-3 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-75 transition-colors"
                    >
                      {loadingPdf === doc.id ? (
                        <>
                          <svg
