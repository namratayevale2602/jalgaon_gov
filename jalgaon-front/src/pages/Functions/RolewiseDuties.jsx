...
const RolewiseDuties = () => {
  ...
  // Icon mapping
  const iconMap = {
    FaUserTie: <FaUserTie className="text-blue-600" size={20} />,
    FaFileAlt: <FaFileAlt className="text-blue-600" size={20} />,
    FaUserShield: <FaUserShield className="text-blue-600" size={20} />,
    FaChartLine: <FaChartLine className="text-blue-600" size={20} />,
    FaMoneyBillWave: <FaMoneyBillWave className="text-blue-600" size={20} />,
    FaUserCog: <FaUserCog className="text-blue-600" size={20} />,
    FaCar: <FaCar className="text-blue-600" size={20} />,
    FaUser: <FaUser className="text-blue-600" size={20} />,
  };
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `http://127.0.0.1:8000/api/role-duties?lang=${language}`
        );
        if (!response.ok) {
