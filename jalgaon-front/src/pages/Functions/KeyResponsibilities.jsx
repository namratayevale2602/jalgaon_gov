...
const KeyResponsibilities = () => {
  ...
  // Icon mapping
  const iconMap = {
    FaFileAlt: <FaFileAlt className="text-blue-600 text-2xl" />,
    FaCheckCircle: <FaCheckCircle className="text-blue-600 text-2xl" />,
    FaUsersCog: <FaUsersCog className="text-blue-600 text-2xl" />,
    FaCog: <FaCog className="text-blue-600 text-2xl" />,
    FaTasks: <FaTasks className="text-blue-600 text-2xl" />,
    FaClipboardList: <FaClipboardList className="text-blue-600 text-2xl" />,
  };
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `http://127.0.0.1:8000/api/key-responsibilities`
        );
        if (!response.ok) {
